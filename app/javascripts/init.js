...
App = Em.Application.create({
    ...
    QuizController: Em.ArrayController.extend(),
    ResultsView: Em.View.extend({
        templateName: 'results'
    }),
    ResultsController: Em.ArrayController.extend(),
    ...
    Router: Ember.Router.extend({
        ...
        root: Ember.Route.extend({
            ...
            quiz: Ember.Route.extend({
                route: '/quiz',
                enter: function(router) {
                    console.log("Entered in quiz");
                },
                connectOutlets: function(router, context) {
                    router.get('applicationController').connectOutlet('quiz');
                }
            }),
