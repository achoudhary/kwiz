App.Controller.timerController = Em.Object.create({
    ...
    updateTimeLeft: function () {
        var now = new Date(), diff = now - this._startedAt, rotationDegrees = 360 - (360 * ((this.get('totalTime') - diff) / this.get('totalTime')));
    ...
    formatTime: function (str) {
        var seconds = parseInt(Math.round(str / 1000), 10), minutes = parseInt(seconds / 60, 10);
        function pad(num) {
            if (num < 10) {
                return '0' + num;
            } else {
